...
class ComplextypedFU {
     ...
     * Here added only for exploring Xtend's embedded DSL design capabilities
     */
    override -> (de.grammarcraft.xtend.flow.InputPort<List<String>> foreignInputPort) {
        output -> foreignInputPort
    }
     ...
     * Here added only for exploring Xtend's embedded DSL design capabilities
     */
    override -> (de.grammarcraft.xtend.flow.OutputPort<List<String>> foreignOutputPort) {
        output -> foreignOutputPort
    }
